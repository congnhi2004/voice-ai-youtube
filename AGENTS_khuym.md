...
1. Read `AGENTS_khuym.md` at session start and again after any context compaction.
...
5. After compaction, re-read `AGENTS_khuym.md`, run `node .codex/khuym_status.mjs --json` if present, then re-open `.khuym/HANDOFF.json`, `.khuym/state.json`, `.khuym/STATE.md`, and the active feature context before more work.
